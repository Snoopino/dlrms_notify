window.addEventListener("message", function (event) {
  ...
  if (data.notification) {
    switch (data.notification_type) {
      ...
      case "information":
        dlrms.information(data.notification, {
          position: "top-right",
          duration: data.duration,
        });
        break;
      ...
      case "warning":
        dlrms.warning(data.notification, {
          position: "top-right",
          duration: data.duration,
        });
        break;
...
(() => {
  ...
  window.dlrms = {
    ...
    information(message, options) {
      show(message, options, "information");
    },
  ...
  function setDlrmsCardContent(DlrmsCard) {
    ...
    header.textContent = `${DlrmsCard.options.type}`;
    message.textContent += `${DlrmsCard.options.message}`;
    DlrmsCard.appendChild(header);
    DlrmsCard.appendChild(message);
  }
